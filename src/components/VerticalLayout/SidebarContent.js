          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/#" className="has-arrow waves-effect">
                ...
                <span>{props.t("Donateurs")}</span>
              </Link>
              <ul className="sub-menu" >
                
                <li>
                  <Link to="/VoireDonateur">{props.t("Voir Donateur")} </Link>
                </li>
                <li>
                  <Link to="/AjouterDonateur">{props.t("Ajouter Donateurs")} </Link>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="sub-menu" >
                ...
                <li>
                  <Link to="/AjouterStaff">{props.t("AjouterStaff")} </Link>
                </li>
                <li>
                  <Link to="/email-compose">{props.t("Contactez ")} </Link>
                </li>
