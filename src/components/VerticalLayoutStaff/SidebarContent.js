          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/VoirDonneur-Staff">
                    {props.t("Voir Donneurs")}{" "}
                  </Link>
                </li>

                <li>
                  <Link to="/ContactezDonneur-Staff">
                    {props.t("Contactez ")}{" "}
                  </Link>
                </li>
              </ul>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/VoirDocteur-Staff">
                    {props.t("Voir Les Docteurs")}{" "}
                  </Link>
                </li>

                <li>
                  <Link to="/ContactezDocteur-Staff">
                    {props.t("Contactez")}{" "}
                  </Link>
                </li>
              </ul>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/Voir-LeStockDeSang-Staff">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/VoirCollectesStaff">
                    {props.t("Voir Les Collectes")}{" "}
                  </Link>
                </li>
              </ul>
            </li>
