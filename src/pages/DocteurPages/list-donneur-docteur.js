...
const BasicTable = props => {
  ...
  const handleEditDonateur = async () => {
    try {
      ...
      setModalOpen8(false) // Fermer le modal après la modification réussie
    } catch (error) {
  ...
  return (
    <React.Fragment>
      ...
      <Modal isOpen={modalOpen8} toggle={() => setModalOpen8(!modalOpen8)}>
        <ModalHeader toggle={() => setModalOpen8(!modalOpen8)}>
          Modifier Donateur
        </ModalHeader>
        <ModalBody>
            ...
            <form>
              ...
              <div className="form-group">
                ...
                <input
                  type="text"
                  className="form-control"
                  value={selectedDonateur.GroupeSanguin}
                  onChange={e =>
                    setSelectedDonateur({
                      ...selectedDonateur,
        ...
        <ModalFooter>
          <Button color="secondary" onClick={() => setModalOpen8(!modalOpen8)}>
            Fermer
          </Button>
