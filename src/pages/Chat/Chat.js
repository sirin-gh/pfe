...
const Chat = props => {
  ...
  const breadcrumbItems = [
    { title: "Contactez", link: "#" },
    { title: "Chatting", link: "#" },
    { title: "Chat", link: "#" },
  ]

  useEffect(() => {
    props.setBreadcrumbItems("Contactez", breadcrumbItems)
  })
  ...
  const ChatProperties = createSelector(selectChatState, Chat => ({
    chats: Chat.chats,
    groups: Chat.groups,
  ...
  const addMessage = () => {
    ...
    axios
      .post("http://localhost:5000/create-message", {
        to: "abdessamadaya1@gmail.com", // Remplacez par le destinataire réel
        subject: "Sujet de l'e-mail", // Remplacez par le sujet réel
        text: curMessage,
      })
      .then(response => {
        console.log(response.data) // Gérer la réponse de l'API comme nécessaire
        // Réinitialiser le champ de saisie et réactiver
        setcurMessage("")
        setDisable(false)
      })
      .catch(error => {
        ...
        setDisable(false) // Réactiver le bouton
      })
  }
  return (
    <React.Fragment>
        ...
        <Card className="chat-leftsidebar">
          <CardBody>
            <div className="text-center bg-light rounded px-4 py-3">
              ...
              <p className="text-muted mb-0">les personnes Disponibles</p>
            </div>
          </CardBody>
                      ...
                      {groups &&
                        groups.map(group => (
                          <li
                            ...
                            className={
                              currentRoomId === group.roomId ? "active" : ""
                            }
                          >
                            <Link
                              to="#"
                    ...
                    <div className="p-3 pt-0">
                      {contacts &&
                        contacts.map(contact => (
                          ...
                          >
                            <div className="px-3 contact-list">
                              {contact.category}
                            </div>
                  ...
                  <div className="d-flex align-items-center">
                    <div className="flex-shrink-0 avatar me-3 d-sm-block d-none">
                      <img
                        src={user2}
                        alt=""
                        className="img-fluid d-block avatar rounded-circle"
                      />
                    </div>
                    <div className="flex-grow-1">
                                ...
                                <div className="flex-1 ms-3">
                                  ...
                                  <div className="ctext-wrap">
                                    <div className="ctext-wrap-content">
                                      <p className="mb-0">{userMsg.msg}</p>
                                    </div>
